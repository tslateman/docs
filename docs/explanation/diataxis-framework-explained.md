...
Diátaxis recognizes that users approach documentation with four distinct needs:

**Learning Mode**

- Users are students seeking understanding
- They need safe, guided experiences
- Success means new capabilities
- Failure should be impossible

**Working Mode**

- Users have specific goals
- They need efficient paths
- Success means task completion
- Theory is a distraction

**Reference Mode**

- Users seek specific information
- They need accurate, complete data
- Success means finding facts quickly
- Opinions are unwelcome

**Understanding Mode**

- Users want deeper knowledge
- They need context and connections
- Success means "aha!" moments
- Instructions would interrupt flow
...
How-to guides respect the user's time and goals:

**Assumption of Competence**

- Users know basics
- They have clear objectives
- They can handle options
- They'll adapt as needed

**Multiple Paths**
Unlike tutorials' single path, how-to guides acknowledge reality:
...
How-to guides are like recipes:

- Clear ingredients (prerequisites)
- Step-by-step method
- Expected outcome
- Variations noted
...
Reference documentation requires meticulous organization:
...
Like dictionaries, reference should:

- Define without persuading
...
Explanation illuminates the why behind the what:
...
### The Academic Paper Parallel

Explanations share qualities with academic writing:
